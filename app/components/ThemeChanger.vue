...
<template>
  <UiDropdown
    ...
    ><div
      class="min-w-6 min-h-6 flex justify-center items-center cursor-pointer rounded text-neutral-900 w-6 hover:bg-neutral-100 dark:hover:bg-neutral-900 dark:text-zinc-50"
    >
      <ColorScheme
        ><Icon
          :name="
