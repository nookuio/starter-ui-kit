...
const emit = defineEmits<{ blur: [value: any]; input: [value: any] }>();
...
<template>
  ...
  >
    ...
    />
    <input
      class="text-sm outline-none text-neutral-900 w-full bg-transparent placeholder:text-neutral-400 dark:text-neutral-100"
      :type="inputType"
